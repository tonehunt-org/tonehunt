...
const Searchbar = ({ value, className, ...props }: InputProps) => {
  ...
  const inputClassNames =
    "w-full max-w-3xl border pl-10 pr-5 py-3 text-sm block p-2.5 bg-transparent border-gray-600 placeholder-gray-400 text-white focus:ring-tonehunt-blue-medium focus:border-tonehunt-blue-medium";
