          ...
          <div className="flex flex-row items-start">
            ...
            <div className="flex-grow">
              <div className="flex flex-col">
                ...
                <ul className="list-none m-0 p-0 text-[10px] text-tonehunt-gray-lighter flex lg:max-w-[500px] items-center flex-wrap gap-2 uppercase font-satoshi-medium my-1.5">
                  {model.tags.map((tag) => {
